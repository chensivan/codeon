...
*/
		socket.on('disconnect', function () {
			...
			alert('CodeOn - Disconnected with :'+prefs.getServerURL() + " \n Check your server and restart your Atom.io");
    ...
    socket.on('status_updated', function(msg) {
			...
			$rootScope.requests.every(function(obj){
				if(obj.question_id==requestID){
					return exist = true;
				}
			});
			if(exist){
