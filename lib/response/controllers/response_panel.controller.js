...
var $ = require('jquery');
var tooltipTemplate = require('../../utils/requestbutton-template.js');
		...
		atom.workspace.observeTextEditors(function(edi){
			edi.observeSelections(function(sel){
				...
				sel.onDidChangeRange(function(){
					// console.log(edi.isEmpty());

					// if(edi.selections[0].isEmpty()){
					// 	//show icon
					// 	element.el.innerHTML = tooltipTemplate({}, this);
