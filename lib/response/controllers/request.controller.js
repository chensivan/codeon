...
app.controller("RequestController", ['$scope','$rootScope','QuestionManager','ResponseManager','$anchorScroll',function ($scope,$rootScope,$anchorScroll,QuestionManager,ResponseManager) {
	...
	$scope.annotationResponse = function(response){
		ResponseManager.viewAnnotation(response,$scope.showTips);
		$scope.showTips = $scope.showTips=="Show me"?"Close it!":"Show me";
	}

	$scope.inlineCodeResponse = function(response){
		ResponseManager.viewCodeDiff(response, $scope.showMerge);
		$scope.showMerge = $scope.showMerge=="Show code difference"?"Close it!"
